...
(function () {
    ...
    function startApp() {
        ...
        // Nav items that require an active premium subscription. Profile is
        ...
        // user's live premium status (flips from "Unlock every feature" to
        ...
        function bzRefreshProfilePremiumCard() {
            ...
            if (!sub) return;
            sub.textContent = bzIsPremiumUser() ? 'All features unlocked — manage your plan here' : 'Unlock Premium from just ₹39 — unlocks everything';
        }
        ...
        let _bzPremiumSelectedPlan = { id: 'month', hours: 720, amount: 39 }; // matches the pre-selected card
...
(function () {
    ...
    async function handleMore() {
        ...
        if (navigator.share) {
            const payload = {
                title: `BeatZen — ${currentAlbum?.title || ''}`,
                url: shareUrl(),
            };
            if (blob) {
